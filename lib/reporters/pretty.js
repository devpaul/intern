...
define([
	...
	function drawProgressBar(report, width) {
		...
		charm.write(pad(barSize - results.length) + '] ' + padLeft(report.finished, totalStrLen) + '/' + report.total);
	}
	...
	var pretty = {
		...
		start: function () {
			...
			process.stdout.on('resize', function () {
				this.dimensions.width = process.stdout.columns;
				this.dimensions.height = process.stdout.rows;
			});
			...
			// TODO render results
			// TODO write a full log
			// TODO display coverage report
		}
	};
